...
namespace EpiManager.Controllers
{
    public class CustomerController : Controller
    {
        ...
        {
            var customers = db.Customers.Include(c => c.PriceHeader);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,MobileNumber,FullName,PriceHeaderId")] Customer customer)
        {
            if (ModelState.IsValid)
            {
